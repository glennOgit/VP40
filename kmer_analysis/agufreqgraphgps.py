...
df = pd.read_csv('gemanalysis2018.pos.GPS_events.fa', sep='\t',names='s')
...
kmerdf.drop(['AGT'], axis=1).plot(kind='line',color='Gray',lw=.5)
plt.plot(kmerdf['AGT'],color='blue')
...
plt.savefig('GPSAGTplotgray.pdf')
kmerdf.to_csv(r'AGTgpspandasgray.txt', header=True, index=True, sep=' ', mode='a')
